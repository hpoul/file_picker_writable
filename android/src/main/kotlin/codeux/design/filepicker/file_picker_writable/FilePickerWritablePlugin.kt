...
public class FilePickerWritablePlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "file_picker_writable")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "file_picker_writable")
